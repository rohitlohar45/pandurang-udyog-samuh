...
const ServiceTwo = () => {
	...
	return (
		<>
			{/* service area start */}
			<div className="service-area pd-top-115 pd-bottom-120" style={{ background: "#f9f9f9" }}>
					...
					<div className="row">
						<div className="col-lg-6">
							<div className="section-title">
								...
								<p>
									Quickly optimize cooperative models for long-term high-impact ROI. Drive
							...
							<div className="item">
								...
								>
									...
									<div className="details">
										...
										<p>
											Energistically reconceptualize ubiquitous solution wherea market-driven
											expertise. Synergistical empower parallel processes with highly efficient
											infomediaries.
										</p>
