						...
						<ul className="nav nav-pills" id="pills-tab" role="tablist">
							<li className="nav-item" role="presentation">
								<button
									...
									aria-selected="true"
								>
									<img src="assets/img/request-quote/1.png" alt="Pandurang Udyog Samuh" />
									REQUEST A QUOTE
								</button>
							</li>
							<li className="nav-item" role="presentation">
								<button
									...
									aria-selected="false"
								>
									<img src="assets/img/request-quote/2.png" alt="" /> TRACK &amp; TRACE
								</button>
							</li>
						</ul>
							...
							>
								<div className="row">
									...
									<div className="col-lg-4 align-self-end">
										<div className="quote-wrap" style={{ background: "var(--main-color)" }}>
											<h4>How Can We Help You!</h4>
											<p>
												Completely transform sticky ideas without leveraged quality vectors.
												Continually negotiate compelling partnerships before granular customer
												service. Objectively.
											</p>
