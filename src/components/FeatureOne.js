            ...
            <Slider {...settings}>
              <div className="item">
                <div className="feature-wrap bg-pink">
                  ...
                  <p>
                    We offer premium banana tissue plants & essential farm
                    supplies (fertilizers, irrigation, & solar) partnered with
                    leading brands like Jain & Yara.
                  </p>
              ...
              <div className="item">
                <div className="feature-wrap bg-ash">
                  ...
                  <p>
                    17 year veteran supplying banana packaging to DP Fruit &
                    major chains (Reliance Fresh, INI, Desai, S K).
                  </p>
                  <div className="btn-wrap">
                    <Link
                      className="read-more-text"
              ...
              <div className="item">
                <div className="feature-wrap bg-sky">
                  ...
                  <p>
                    APEDA-approved pack house specializing in enhancing banana
                    packaging quality and quantity, with a daily 100-ton
                    capacity.
                  </p>
                  <div className="btn-wrap">
                    <Link
              ...
              <div className="item">
                <div className="feature-wrap bg-ash">
                  ...
                  <p>
                    APEDA-approved cold storage with 2000 metric ton capacity,
                    featuring pre-cooling and 10 cold chambers, powered by
                    eco-friendly solar panels.
                  </p>
                  <div className="btn-wrap">
                    <Link
                      className="read-more-text"
                      to="/service-details/pan-exports-cold-storage"
                    >
                      READ MORE{" "}
                      <span>
                        <FaArrowRight />
              ...
              <div className="item">
                <div className="feature-wrap bg-pink">
                  ...
                  <p>
                    Pandurang Petroleum Services is an authorized HP dealer for
                    petroleum products.
                  </p>
                  <div className="btn-wrap">
                    <Link
              ...
              <div className="item">
                <div className="feature-wrap bg-pink">
                  ...
                  <p>
                    We're authorized dealers for Rajuri steel, Ambuja & Shree
                    cement, Rainbow tanks, and offer a wide range of building
                    materials like cement, steel, windows, doors.
                  </p>
                  <div className="btn-wrap">
                    <Link
                      className="read-more-text"
              ...
              <div className="item">
                <div className="feature-wrap bg-pink">
                  ...
                  <p>
                    Pandurang Industries: Your source for crushed stone (20mm,
                    10mm, 6mm dust), crush sand, and washed sands (M & Plaster).
                  </p>
                  <div className="btn-wrap">
                    <Link
                      className="read-more-text"
