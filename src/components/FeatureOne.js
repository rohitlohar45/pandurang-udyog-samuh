						...
						<div className="col-lg-6 align-self-center">
							<div className="section-title">
								<p className="content left-line">
									...
									Holisticly engineer performance based value. Assertively benchmark turnkey
						...
						<Slider {...settings}>
							<div className="item">
								<div className="feature-wrap bg-pink">
									<div className="icon">
										<img src="assets/img/icon/feature-1.png" alt="Pandurang Udyog Samuh" />
									</div>
									<h5>TRANSPARENT PRICING</h5>
									<p>
										Globally initiate resource maximizing total linkage via enabled process
										improvements.
									</p>
								</div>
							</div>
							<div className="item">
								<div className="feature-wrap bg-ash">
									<div className="icon">
										<img src="assets/img/icon/feature-2.png" alt="Pandurang Udyog Samuh" />
									</div>
							...
							<div className="item">
								<div className="feature-wrap bg-sky">
									<div className="icon">
										<img src="assets/img/icon/feature-3.png" alt="Pandurang Udyog Samuh" />
									</div>
