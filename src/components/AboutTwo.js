						...
						<div className="row">
							<div className="col-lg-5 order-lg-2">
								<div className="about-thumb-wrap mb-lg-0 mb-4">
									...
									/>
									<img className="img-2" src="assets/img/about/7.png" alt="Pandurang Udyog Samuh" />
									<img className="img-3" src="assets/img/about/8.png" alt="Pandurang Udyog Samuh" />
							...
							<div className="col-lg-7 align-self-center order-lg-1">
								<div className="about-inner-wrap ms-0">
									<div className="section-title mb-0">
										...
										<p>
											Objectively transition 24/365 e-tailers before cross functional collaboration
											and idea-sharing. Competently iterate plug-and-play deliverables vis-a-vis
										...
										<div className="row">
											<div className="col-xl-6">
												<div className="single-about-wrap">
													<div className="icon">
														<img src="assets/img/about/icon-1.png" alt="Pandurang Udyog Samuh" />
													</div>
													<div className="details">
											...
											<div className="col-xl-6">
												<div className="single-about-wrap">
													<div className="icon">
														<img src="assets/img/about/icon-2.png" alt="Pandurang Udyog Samuh" />
													</div>
													<div className="details">
