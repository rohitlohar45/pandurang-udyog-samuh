					...
					<div className="row">
						<div className="col-xl-6 col-lg-5 order-lg-2">
							<div className="thumb text-center mb-4 mb-lg-0">
								<img src="assets/img/faq/1.png" alt="Pandurang Udyog Samuh" />
							</div>
						</div>
						<div className="col-xl-6 col-lg-7 order-lg-1">
							<div className="section-title">
								...
								<p className="content">
									Progressively utilize integrated bandwidth via vertical relationships. Objectively
									impact emerging human capital via tactical methods of empowerment.
								</p>
							</div>
								...
								<div className="accordion-item single-accordion-inner">
									...
									>
										<div className="accordion-body">
											Professionally disseminate highly efficient human capital through optimal
											technology. Distinctively enhance tactical data and innovative content.
										</div>
									</div>
								</div>
								<div className="accordion-item single-accordion-inner">
