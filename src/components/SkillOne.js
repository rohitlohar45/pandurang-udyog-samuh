...
const SkillOne = () => {
	return (
		<>
			{/*skill-area start*/}
			<div className="skill-area pd-top-120 pd-bottom-120" style={{ background: "#f9f9f9" }}>
					...
					<div className="row justify-content-center">
						...
						<div className="col-lg-6 order-lg-1">
							<div className="section-title mt-lg-0 mt-5">
								...
								<p>
									Globally foster client-centered convergence through accurate deliverables.
									Synergistically actualize transparent.
								</p>
							</div>
