					...
					<div className="row justify-content-center">
						<div className="col-lg-4 col-md-6">
							<div className="single-service-wrap">
								<div className="thumb">
									<img src="assets/img/service/1.png" alt="PAUS" />
									<div className="icon">
										<img src="assets/img/service/service-icon-1.png" alt="PAUS" />
									</div>
								</div>
						...
						<div className="col-lg-4 col-md-6">
							<div className="single-service-wrap">
								<div className="thumb">
									<img src="assets/img/service/2.png" alt="PAUS" />
									<div className="icon">
										<img src="assets/img/service/service-icon-2.png" alt="PAUS" />
									</div>
								</div>
								<div className="details">
						...
						<div className="col-lg-4 col-md-6">
							<div className="single-service-wrap">
								<div className="thumb">
									<img src="assets/img/service/3.png" alt="PAUS" />
									<div className="icon">
										<img src="assets/img/service/service-icon-3.png" alt="PAUS" />
									</div>
								</div>
								<div className="details">
									<h5>WAREHOUSING</h5>
