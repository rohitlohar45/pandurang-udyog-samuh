const serviceContent = {
	"pan-exports-cold-storage": {
		information: {
			...
			description1:
				"Pan Exports Cold Storage stands as a leading provider of temperature-controlled storage solutions, catering to the diverse needs of industries such as agriculture, pharmaceuticals, and food processing. With a rich legacy of experience and an unwavering commitment to excellence, we have solidified our position as a trusted partner for businesses seeking reliable cold storage facilities.",
			description2:
		...
		support: {
			...
			description:
				"Our customer support team is available round the clock to address any queries or concerns you may have. Whether you need assistance with inventory management or have questions about our services, feel free to contact us via email or phone.",
	...
	"pandurang-agro-industries-cold-storage": {
		information: {
			...
			description3:
				"Our cold storage units are designed to accommodate a wide range of agricultural products, including fruits, vegetables, dairy products, and floral items. With multiple chambers and temperature zones, we can cater to the unique storage needs of different types of produce, ensuring optimal freshness and longevity.",
			description4:
				"At Pandurang Agro Industries Cold Storage, we understand the importance of sustainability and environmental responsibility. That's why we have implemented energy-efficient systems and eco-friendly practices to minimize our carbon footprint. From LED lighting to advanced insulation materials, we prioritize sustainability in every aspect of our operations.",
			image1: "/assets/img/service/pandurang-agro-industries-cold-storage/1.jpg",
			image2: "assets/img/service/pandurang-agro-industries-cold-storage/2.png",
		},
		support: {
			title: "24/7 ONLINE SUPPORT",
			description:
				"Our team is committed to providing exceptional support round the clock. Whether you have questions about our services or need assistance with your stored inventory, our customer support team is here to help. Reach out to us via email or phone for prompt assistance.",
	...
	"dp-fruit-suppliers-reliance-ini-sk": {
		...
		support: {
			title: "24/7 ONLINE SUPPORT",
			description:
				"Our customer support team is dedicated to ensuring your satisfaction. Whether you need assistance with order tracking or have questions about our products, we're here to help. Contact us anytime via email or phone for personalized support.",
	...
	"pandurang-krushi-udyog-banana-tissue-drip": {
		information: {
			...
			description4:
				"At Pandurang Krushi Udyog, we recognize the importance of sustainability and environmental stewardship in agriculture. That's why we promote the adoption of eco-friendly farming practices and resource-efficient technologies, such as drip irrigation, which minimize water wastage and reduce environmental footprint.",
			image1: "/assets/img/service/pandurang-krushi-udyog-banana-tissue-drip/1.gif",
			image2: "assets/img/service/pandurang-krushi-udyog-banana-tissue-drip/2.png",
		},
		support: {
			title: "24/7 ONLINE SUPPORT",
			description:
				"Our team of agricultural experts is available round the clock to provide guidance and support to farmers. Whether you need assistance with crop management techniques or have questions about our products, we're here to help. Reach out to us via email or phone for personalized assistance.",
	...
	"pandurang-petroleum-services-hp-dealer": {
		...
		support: {
			title: "24/7 ONLINE SUPPORT",
			description:
				"Our dedicated support team is available round the clock to address any concerns or queries you may have. Whether you need assistance with fuel delivery scheduling or have questions about our services, we're here to help. Contact us via email or phone for prompt assistance.",
	...
	"pandurang-steel-building-material": {
		...
		support: {
			title: "24/7 ONLINE SUPPORT",
			description:
				"Our customer support team is dedicated to providing exceptional service round the clock. Whether you have questions about product specifications or need assistance with order processing, we're here to help. Contact us anytime via email or phone for personalized support.",
	...
	"pandurang-industries-stone-crusher": {
		information: {
			...
			description1:
				"Pandurang Industries specializes in providing high-quality stone aggregates that are essential for construction projects of all sizes. With a steadfast focus on quality and reliability, we ensure that our products meet and exceed the highest industry standards, delivering exceptional value to our clients.",
			description2:
		...
		support: {
			title: "24/7 ONLINE SUPPORT",
			description:
				"Our customer support team is committed to ensuring your satisfaction at every stage of your project. Whether you need assistance with product selection or have questions about delivery logistics, we're here to help. Contact us via email or phone for prompt assistance.",
